(() => {
  ...
  const EN = {
    ...
    '您好，欢迎致电智能客服中心。请问有什么可以帮您？如需人工服务，请按零。': 'Hello, and welcome to our intelligent customer service center. How may I help you today? Press zero to speak with an agent.',
    ...
    '带入体验台 · 消耗 100 点': 'Open in studio · Costs 100 points',
    ...
    '开始克隆 · 消耗 50 点': 'Start cloning · Costs 50 points',
    ...
    '音量': 'Volume',
    '音高': 'Pitch',
    '高级设置（格式 / 采样率）': 'Advanced settings (format / sample rate)',
    '音频格式': 'Audio format',
    '采样率': 'Sample rate',
    ...
    '本次合成将消耗 50 点配额': 'This synthesis will cost 50 quota points',
    ...
    '登录账户': 'Sign in',
    '使用邮箱验证码安全登录，个人配置将与账号保持同步。': 'Sign in securely with an email verification code. Your personal settings stay linked to your account.',
    ...
    '公司名称': 'Company',
    '可选': 'Optional',
    '方便我们更好地为你服务': 'Helps us serve you better',
    '发送验证码': 'Send verification code',
    '首次使用的邮箱将在验证码验证通过后自动注册，无需设置密码。': 'A first-time email address is registered automatically after verification. No password is required.',
    ...
    '推荐': 'Recommended',
    '/月': '/month',
    '每日 300 次配额': '300 daily quota units',
    '✅ 每日 300 次配额': '✅ 300 daily quota units',
    ...
    '选择专业版': 'Choose Pro',
    '企业': 'Enterprise',
    '每日 1000 次配额': '1,000 daily quota units',
    '✅ 每日 1000 次配额': '✅ 1,000 daily quota units',
  ...
  function translatePattern(source) {
    ...
    if ((match = source.match(/^剩余 (\d+)$/))) return `${match[1]} remaining`;
